...
public class LogTesterMain2 {
	
	private static final Logger logger = LogManager.getLogger(LogTesterMain2.class);
	static DateFormat formatter = new SimpleDateFormat("yyyyMMdd_HH");

	public static void main(String[] args) {
		LogTester.initializeYourLogger("./LOGS/LOG/TLOG_TEST_","--------------This is Main-JVM-2-customized header----------------\n");
		logger.debug("Hello from Log4j2 Main-2");
